package com.example.goro.applikegmail.adapter;
...
import com.example.goro.applikegmail.helper.CircleTransform;
import com.example.goro.applikegmail.helper.FlipAnimator;
...
//    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener {
        ...
        public MyViewHolder(View view) {
            ...
            timstamp = view.findViewById(R.id.timestamp);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.timstamp.setText(message.getTimestamp());
